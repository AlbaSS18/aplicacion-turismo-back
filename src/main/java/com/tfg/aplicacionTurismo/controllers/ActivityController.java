...
public class ActivityController {
    ...
    public ResponseEntity<List<ActivityDTO>> getListado(){
        ...
        for(Activity activity: listActivity){
            ActivityDTO i = new ActivityDTO();
            i.setName(activity.getName());
            i.setDescription(activity.getDescription());
            i.setLatitude(activity.getCoordenates().getX());
            i.setLongitude(activity.getCoordenates().getY());
            listDTO.add(i);
        }
